...
geth --dev --datadir /root/.ethereum --rpc --rpcaddr 0.0.0.0  --rpcvhosts=* --rpcport 9545 --networkid 108 --rpcapi 'eth,net' --gasprice '0' --targetgaslimit '4294967295' --gcmode=archive console
